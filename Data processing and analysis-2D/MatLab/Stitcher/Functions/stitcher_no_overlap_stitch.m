function    stitcher_no_overlap_stitch(File, Settings);
    ...
    for well_n = 1:size(temp.wells,1) %loop over wells
        ...
        for timepoint=1:unique(File.files_list_s.Lambda_n):size(File.im_all{1,1}{1,1},1), %loop over timepoints
            ...
            try
                ...
                results = post_process_results_stitching_no_overlap(File,Settings); % need some work here on defining rows and cols used
