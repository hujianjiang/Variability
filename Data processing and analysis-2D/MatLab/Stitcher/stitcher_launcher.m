...
Settings.lab = 'Geiger';
Settings.im_c_correctionfactor = 1; %this is the correction factor for the overlap of nuclei and cell images for the gifs that are created, applied to the cell images
Settings.im_n_correctionfactor = 8;
...
File.experiment_details = 'D:/Data/MULTIMOT/Original data/Geiger Lab/SW/Book1.xlsx';
